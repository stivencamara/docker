...
para fazer reset às passwords do elastic:
elasticsearch-setup-passwords auto

para mudar por utilizador:
elasticsearch-reset-password -u kibana_system -i vukhmYpBQ89MmrcBAK7B
elasticsearch-reset-password -u kibana -i vukhmYpBQ89MmrcBAK7B
elasticsearch-reset-password -u elastic -i KDOUuXox9JFMAWWC61rX