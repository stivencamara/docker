...
-- CLEAR ALL
    ...
    CREATE TEMPORARY TABLE vMainTempTable (PK_Organization_Id INT, PK_Organization_Version INT, Fk_Organization_Parent_Id INT, Fk_Organization_Parent_Version INT, Level INT,
									...
									Poc_Id INT, Poc_Version INT, Poc_Name VARCHAR(1024), Poc_Record_State_Type_Id INT, Poc_Active BIT, Tree_Order INT,
	...
	INSERT INTO vMainTempTable (PK_Organization_Id, PK_Organization_Version, Fk_Organization_Parent_Id, Fk_Organization_Parent_Version, Level, 
					Can_Have_Points_Of_Care, Can_Have_Services, Group_Name, FK_Record_State_Type_Id, Organization_Active, Approved_Date, Obsoleted_Date, Tree_Order)
	(
		SELECT PK_Organization_Id, PK_Organization_Version, Fk_Organization_Parent_Id, Fk_Organization_Parent_Version, Level, 
                    ...
                    Approved_Date, Obsoleted_Date,Tree_Order
		FROM (
			SELECT o.PK_Organization_Id, o.PK_Organization_Version, oo.Fk_Organization_Parent_Id, oo.Fk_Organization_Parent_Version, 0 AS Level,
				5 AS FK_Record_State_Type_Id, o.Approved AS Approved_Date, oo.Obsoleted_Date,
				 o.Can_Have_Points_Of_Care, o.Can_Have_Services, o.Group_Name, o.Organization_Active, o.Tree_Order,
	...
	WITH RECURSIVE RecursiveCTE (PK_Organization_Id, PK_Organization_Version, Fk_Organization_Parent_Id, FK_Organization_Parent_Version, Level, FK_Record_State_Type_Id, Approved, Obsoleted_Date,
					Can_Have_Points_Of_Care, Can_Have_Services, Group_Name, Organization_Active,Tree_Order)
	AS
	(
				...
				SELECT t2.PK_Organization_Id, t2.PK_Organization_Version, t2.Fk_Organization_Parent_Id, t2.FK_Organization_Parent_Version, cte.Level + 1,
						...
						t2.Can_Have_Points_Of_Care, t2.Can_Have_Services, t2.Group_Name, t2.Organization_Active, t2.Tree_Order
	...
	SELECT cte.PK_Organization_Id, cte.PK_Organization_Version, cte.Fk_Organization_Parent_Id, cte.Fk_Organization_Parent_Version, cte.Level,
					texts.Name, cte.Can_Have_Points_Of_Care, cte.Can_Have_Services, cte.Group_Name, cte.FK_Record_State_Type_Id, cte.Organization_Active, cte.Tree_Order,
			...
			LEFT JOIN (
				SELECT p.FK_Point_Of_Care_Id, p.FK_Point_Of_Care_Version, p.FK_Organization_Parent_Id, p.FK_Organization_Parent_Version, p.Approved_Date, p.Created_Date, 
						...
						p0.Active, p0.Approved, p0.Approved_Version, p0.Code, p0.Created, p0.FK_Created_By, p0.Deleted, p0.End_Date, p0.FK_Address_Id, p0.FK_Approved_By, 
						...
						p0.Start_Date, p0.Updated, p0.FK_Updated_By, p1.PK_Point_Of_Care_Text_Id, p1.Abreviation, p1.Attendance_Restrictions, p1.Description, 
						...
						t2.Code AS Code0, t2.Cost, t2.Created AS Created0, t2.FK_Created_By AS Created_By0, t2.Deleted AS Deleted0, t2.End_Date AS End_Date0, t2.FK_Approved_By AS FK_Approved_By0, 
						...
						t2.Processing_Time_Weeks, t2.Processing_Time_Years, t2.Service_Active, t2.Service_Internal, t2.Start_Date AS Start_Date0, t2.Updated AS Updated0, t2.FK_Updated_By AS Updated_By0, 
				...
				LEFT JOIN (
					SELECT s2.FK_Service_Id, s2.FK_Service_Version, s2.FK_Point_Of_Care_Id, s2.FK_Point_Of_Care_Version, s2.Approved_Date, s2.Cost_Id, s2.Created_Date, 
							...
							s3.Active, s3.Approved, s3.Approved_Version, s3.Code, s3.Cost, s3.Created, s3.FK_Created_By, s3.Deleted, s3.End_Date, s3.FK_Approved_By, s3.FK_Business_Event_Id, 
							...
							s3.Start_Date, s3.Updated, s3.FK_Updated_By, s4.PK_Service_Text_Id, s4.Abreviation, s4.Description, s4.FK_Service_Id AS FK_Service_Id0, 
	...
	ORDER BY PK_Organization_Id, PK_Organization_Version, Level,Tree_Order;
...
-- Clear ALL
	...
	INSERT INTO vMainTempTable (PK_Organization_Id, PK_Organization_Version, Fk_Organization_Parent_Id, Fk_Organization_Parent_Version, Level, 
					Can_Have_Points_Of_Care, Can_Have_Services, Group_Name, FK_Record_State_Type_Id, Organization_Active, Tree_Order)
	WITH RECURSIVE RecursiveCTE (PK_Organization_Id, PK_Organization_Version, Fk_Organization_Parent_Id, Fk_Organization_Parent_Version, Level, 
            ...
            (
                SELECT e.PK_Organization_Id, e.PK_Organization_Version, e.Fk_Organization_Parent_Id, e.Fk_Organization_Parent_Version, 0 AS Level,
						e.Can_Have_Points_Of_Care, e.Can_Have_Services, e.Group_Name, e.FK_Record_State_Type_Id, e.Organization_Active, e.Tree_Order
			...
			LEFT JOIN (
				SELECT s.FK_Service_Id, s.FK_Service_Version, s.FK_Organization_Parent_Id, s.FK_Organization_Parent_Version, s.Approved_Date, s.Created_Date, s.FK_Parent_Record_State_Type_Id, 
						...
						s0.Created, s0.FK_Created_By, s0.Deleted, s0.End_Date, s0.FK_Approved_By, s0.FK_Business_Event_Id, s0.FK_Diagram_Attachment_Id, s0.FK_Economic_Activity_Id, s0.FK_Life_Event_Id, 
						...
						s0.Processing_Time_Weeks, s0.Processing_Time_Years, s0.Service_Active, s0.Service_Internal, s0.Start_Date, s0.Updated, s0.FK_Updated_By, s1.PK_Service_Text_Id, s1.Abreviation, 
			...
			LEFT JOIN (
				SELECT p.FK_Point_Of_Care_Id, p.FK_Point_Of_Care_Version, p.FK_Organization_Parent_Id, p.FK_Organization_Parent_Version, p.Approved_Date, p.Created_Date, 
						...
						p0.Approved_Version, p0.Code, p0.Created, p0.FK_Created_By, p0.Deleted, p0.End_Date, p0.FK_Address_Id, p0.FK_Approved_By, p0.FK_Channel_Id, 
						...
						p0.FK_Updated_By, p1.PK_Point_Of_Care_Text_Id, p1.Abreviation, p1.Attendance_Restrictions, p1.Description, p1.FK_Point_Of_Care_Id AS FK_Point_Of_Care_Id0, 
						...
						t2.Approved_Version AS Approved_Version0, t2.Code AS Code0, t2.Cost, t2.Created AS Created0, t2.FK_Created_By AS Created_By0, t2.Deleted AS Deleted0, t2.End_Date AS End_Date0, 
						...
						t2.Start_Date AS Start_Date0, t2.Updated AS Updated0, t2.FK_Updated_By AS Updated_By0, t2.PK_Service_Text_Id, t2.Abreviation AS Abreviation0, t2.Description AS Description0, 
				...
				LEFT JOIN (
					SELECT s2.FK_Service_Id, s2.FK_Service_Version, s2.FK_Point_Of_Care_Id, s2.FK_Point_Of_Care_Version, s2.Approved_Date, s2.Cost_Id, s2.Created_Date, s2.External_Approved_Date, 
							...
							s3.PK_Service_Id, s3.PK_Service_Version, s3.Active, s3.Approved, s3.Approved_Version, s3.Code, s3.Cost, s3.Created, s3.FK_Created_By, s3.Deleted, s3.End_Date, 
							...
							s3.Updated, s3.FK_Updated_By, s4.PK_Service_Text_Id, s4.Abreviation, s4.Description, s4.FK_Service_Id AS FK_Service_Id0, s4.FK_Service_Version AS FK_Service_Version0, 
			...
			if ((SELECT Count(*) FROM vListOfRecordStateTypeIds) > 1) THEN
				...
				IF ((SELECT Count(*) FROM vtemp1) > 0) THEN
					CREATE TEMPORARY TABLE vtemp2 (PK_Organization_Id INT, PK_Organization_Version INT, Fk_Organization_Parent_Id INT, Fk_Organization_Parent_Version INT, Level INT,
										Name VARCHAR(1024), Can_Have_Points_Of_Care BIT, Can_Have_Services BIT, Group_Name INT, FK_Record_State_Type_Id INT, Organization_Active BIT, Tree_Order INT,
                                        Service_Id INT, Service_Version INT, Service_Name VARCHAR(1024), Service_Record_State_Type_Id INT, Service_Active BIT,
			...
			SELECT * FROM vMainTempTable 
				ORDER BY Tree_Order,PK_Organization_Id, PK_Organization_Version, Level;
