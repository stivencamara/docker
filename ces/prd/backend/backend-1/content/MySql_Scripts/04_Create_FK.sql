...
ALTER TABLE Legislations
    ...
    ADD    CONSTRAINT FK_Legislations_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Legislations_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Holidays 
    ADD CONSTRAINT FK_Holidays_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Holidays_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Economic_Activities 
    ADD CONSTRAINT FK_Economic_Activities_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Economic_Activities_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Documents 
    ...
    ADD    CONSTRAINT FK_Documents_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Documents_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Document_Types 
    ADD CONSTRAINT FK_Document_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Document_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Divisions 
    ...
    ADD    CONSTRAINT FK_Divisions_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Divisions_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Division_Types 
    ADD CONSTRAINT FK_Divisions_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Divisions_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Days 
    ADD CONSTRAINT FK_Days_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Days_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Costs 
    ADD CONSTRAINT FK_Costs_Round_Types FOREIGN KEY (FK_Round_Type_Id) REFERENCES Round_Types (PK_Round_Type_Id),
    ADD    CONSTRAINT FK_Costs_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Costs_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Contacts 
    ...
    ADD    CONSTRAINT FK_Contacts_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Contacts_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Contact_Types 
    ADD CONSTRAINT FK_Contact_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Contact_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Contact_Scopes 
    ADD CONSTRAINT FK_Contact_Scopes_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Contact_Scopes_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Channels 
    ...
    ADD    CONSTRAINT FK_Channels_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Channels_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Channel_Types 
    ADD CONSTRAINT FK_Channel_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Channel_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Business_Events 
    ADD CONSTRAINT FK_Business_Events_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Business_Events_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Attachments 
    ADD CONSTRAINT FK_Attachments_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Attachments_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Users 
    ADD CONSTRAINT FK_Users_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Users_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Addresses 
    ...
    ADD    CONSTRAINT FK_Addresses_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Addresses_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Recipient_Types 
    ADD CONSTRAINT FK_Recipient_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Recipient_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Profiles_Permissions 
    ...
    ADD    CONSTRAINT FK_Profiles_Permissions_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Profiles 
    ADD CONSTRAINT FK_Profiles_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Profiles_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Points_Of_Care 
    ...
    ADD    CONSTRAINT FK_Points_Of_Care_Channels FOREIGN KEY (FK_Channel_Id) REFERENCES Channels (PK_Channel_Id),
    ADD    CONSTRAINT FK_Points_Of_Care_Record_State_Types FOREIGN KEY (FK_Record_State_Type_Id) REFERENCES Record_State_Types (PK_Record_State_Type_Id),
    ADD    CONSTRAINT FK_Points_Of_Care_Addresses FOREIGN KEY (FK_Address_Id) REFERENCES Addresses (PK_Address_Id),
    ADD    CONSTRAINT FK_Points_Of_Care_Users_Approved_By FOREIGN KEY (FK_Approved_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Points_Of_Care_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Points_Of_Care_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Permissions 
    ADD CONSTRAINT FK_Permissions_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Permissions_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Parameters 
    ADD CONSTRAINT FK_Parameters_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Parameters_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Organizations 
    ...
    ADD    CONSTRAINT FK_Organizations_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Organizations_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Organization_Types 
    ...
    ADD    CONSTRAINT FK_Organization_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Organization_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Organization_Related_Types 
    ADD CONSTRAINT FK_Organization_Related_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Organization_Related_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Notifications 
    ADD CONSTRAINT FK_Notifications_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Notifications_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Notification_Users 
    ...
    ADD    CONSTRAINT FK_Notification_Users_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Notification_Users_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Locations 
    ...
    ADD    CONSTRAINT FK_Locations_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Locations_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Location_Types 
    ADD CONSTRAINT FK_Location_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Location_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Life_Events 
    ADD CONSTRAINT FK_Life_Events_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Life_Events_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Users_Profiles 
    ...
    ADD    CONSTRAINT FK_Users_Profiles_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Services_Points_Of_Care 
    ...
    ADD    CONSTRAINT FK_Services_Points_Of_Care_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Services_Points_Of_Care_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Services 
    ...
    ADD    CONSTRAINT FK_Services_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Services_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Service_Types 
    ADD CONSTRAINT FK_Service_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Service_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Service_Rules 
    ...
    ADD    CONSTRAINT FK_Service_Rules_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Service_Rules_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Service_Related_Types 
    ADD CONSTRAINT FK_Service_Related_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Service_Related_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Service_Categories 
    ...
    ADD    CONSTRAINT FK_Service_Categories_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Service_Categories_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Schedules 
    ADD CONSTRAINT FK_Schedules_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Schedules_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Round_Types 
    ADD CONSTRAINT FK_Round_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Round_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Result_Types 
    ADD CONSTRAINT FK_Result_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Result_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Requirements 
    ...
    ADD    CONSTRAINT FK_Requirements_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
     ADD   CONSTRAINT FK_Requirements_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Reports 
    ADD CONSTRAINT FK_Reports_Attachments FOREIGN KEY (FK_Attachment_Id) REFERENCES Attachments (PK_Attachment_Id),
    ADD    CONSTRAINT FK_Reports_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
     ADD   CONSTRAINT FK_Reports_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Refusal_Types 
    ADD CONSTRAINT FK_Refusal_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
     ADD   CONSTRAINT FK_Refusal_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);

ALTER TABLE Record_State_Types 
    ADD CONSTRAINT FK_Records_States_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Records_States_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Recipients 
    ...
    ADD    CONSTRAINT FK_Recipients_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Recipients_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Check_Lists 
    ...
    ADD    CONSTRAINT FK_Check_Lists_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Check_Lists_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Object_Types 
    ...
    ADD    CONSTRAINT FK_Object_Types_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Object_Types_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
...
ALTER TABLE Service_Groupings 
    ADD CONSTRAINT FK_Service_Groupings_Created_By FOREIGN KEY (FK_Created_By) REFERENCES Users (PK_User_Id),
    ADD    CONSTRAINT FK_Service_Groupings_Updated_By FOREIGN KEY (FK_Updated_By) REFERENCES Users (PK_User_Id);
