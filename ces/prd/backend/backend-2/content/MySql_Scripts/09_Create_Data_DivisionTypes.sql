...
SELECT COUNT(*) INTO @count FROM Division_Types;
	...
	INSERT INTO Division_Types (Name, Created, Created_By, Updated, Updated_By, Active, Deleted) SELECT 'Não Aplicável',now(),'ces',null,null,1,0 FROM dual WHERE @count = 0;
	...
	INSERT INTO Division_Types (Name, Created, Created_By, Updated, Updated_By, Active, Deleted) SELECT 'Ilha',now(),'ces',null,null,1,0 FROM dual WHERE @count = 0;
	SET @LastDivisionTypeIdSave = LAST_INSERT_ID();
	...
	INSERT INTO Division_Types (Name, Created, Created_By, Updated, Updated_By, Active, Deleted) SELECT 'Concelho',now(),'ces',null,null,1,0 FROM dual WHERE @count = 0;
	SET @LastDivisionTypeIdSave = LAST_INSERT_ID();
	...
	INSERT INTO Division_Types (Name, Created, Created_By, Updated, Updated_By, Active, Deleted) SELECT 'Freguesia',now(),'ces',null,null,1,0 FROM dual WHERE @count = 0;
	SET @LastDivisionTypeIdSave = LAST_INSERT_ID();
